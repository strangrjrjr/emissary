    ...
    constructor(props) {
      ...
      componentDidMount = () => {
        ...
        if (json.error) {
          ...
          this.props.initConversationChannel(state.cable)
          .then(this.props.initMessagesChannel(state.cable))
      ...
      render() {
          const {conversations, activeConversation, error, activeUsers} = store.getState()
        return(
            <Fragment>
                <NavBar 
